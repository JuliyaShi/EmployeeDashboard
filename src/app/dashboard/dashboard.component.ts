...
import jsonData from '../../assets/new_hire.json';
...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  generateJobTitleChart(): void {
    const jobTitles = jsonData.map((item: any) => item.jobTitle);
  ...
  generateGenderChart(): void {
    const genderCounts: { [key: string]: number } = jsonData.reduce((counts: { [key: string]: number }, item: any) => {
